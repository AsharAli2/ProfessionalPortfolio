...
const Footer = () => {
  ...
  return (
    <footer className="py-10 border-t border-gold-500/20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="text-xl font-bold gold-text-gradient">Ashar Ali Khan</Link>
            <p className="text-sm text-gray-500 mt-2">
              Software Engineer specializing in custom software solutions
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="text-sm text-gray-500">
              © {currentYear} Ashar Ali Khan. All rights reserved.
            </p>
          </div>
        </div>
      </div>
